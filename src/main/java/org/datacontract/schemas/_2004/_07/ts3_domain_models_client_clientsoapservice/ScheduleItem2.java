...
@XmlType(name = "ScheduleItem", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.PutDeliveryAddress", propOrder = {
    "dayOfWeek",
    "hourFrom",
    "hourTo",
    "enabled"
...
public class ScheduleItem2 {
    ...
    @XmlElementRef(name = "enabled", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.PutDeliveryAddress", type = JAXBElement.class, required = false)
