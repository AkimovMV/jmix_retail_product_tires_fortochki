...
/**
 * <p>Java class for GetOilResult complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="GetOilResult">
 *   <complexContent>
 ...
 *         <element name="price_rest_list" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetOil}ArrayOfGetOilResultItem" minOccurs="0"/>
...
@XmlType(name = "GetOilResult", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetOil", propOrder = {
    "currencyRate",
    "priceRestList",
    "saleInfoList",
    "totalPages",
...
public class GetOilResult
    extends ClientServiceResult
{

    @XmlElementRef(name = "currencyRate", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetOil", type = JAXBElement.class, required = false)
    protected JAXBElement<CurrencyRate> currencyRate;
    @XmlElementRef(name = "price_rest_list", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetOil", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfGetOilResultItem> priceRestList;
    @XmlElementRef(name = "saleInfoList", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetOil", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfsaleInfo> saleInfoList;
    protected Integer totalPages;
    @XmlElementRef(name = "warehouseLogistics", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetOil", type = JAXBElement.class, required = false)
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfGetOilResultItem }{@code >}
     *     
     */
    public JAXBElement<ArrayOfGetOilResultItem> getPriceRestList() {
     ...
     *     
     */
    public void setPriceRestList(JAXBElement<ArrayOfGetOilResultItem> value) {
