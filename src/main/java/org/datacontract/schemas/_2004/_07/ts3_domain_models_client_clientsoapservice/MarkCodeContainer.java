...
@XmlType(name = "MarkCodeContainer", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetMovementInfo", propOrder = {
    "markCodeImg",
    "markCodeString",
    "artikul"
})
public class MarkCodeContainer {

    @XmlElementRef(name = "MarkCodeImg", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetMovementInfo", type = JAXBElement.class, required = false)
    protected JAXBElement<String> markCodeImg;
    @XmlElementRef(name = "MarkCodeString", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetMovementInfo", type = JAXBElement.class, required = false)
    protected JAXBElement<String> markCodeString;
    @XmlElementRef(name = "artikul", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetMovementInfo", type = JAXBElement.class, required = false)
