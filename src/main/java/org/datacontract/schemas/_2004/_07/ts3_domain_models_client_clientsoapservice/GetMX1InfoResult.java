...
/**
 * <p>Java class for GetMX1InfoResult complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="GetMX1InfoResult">
 *   <complexContent>
 ...
 *         <element name="goods" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetMx1Info}ArrayOfGetMX1InfoGoodsItem" minOccurs="0"/>
...
@XmlType(name = "GetMX1InfoResult", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetMx1Info", propOrder = {
    "guid",
    "baseDocGuid",
    "number",
    "date",
...
public class GetMX1InfoResult
    extends ClientServiceResult
{

    @XmlElementRef(name = "guid", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetMx1Info", type = JAXBElement.class, required = false)
    protected JAXBElement<String> guid;
    @XmlElementRef(name = "baseDocGuid", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetMx1Info", type = JAXBElement.class, required = false)
    protected JAXBElement<String> baseDocGuid;
    @XmlElementRef(name = "number", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetMx1Info", type = JAXBElement.class, required = false)
    protected JAXBElement<String> number;
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar date;
    protected Integer statusID;
    protected Integer whID;
    @XmlElementRef(name = "goods", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetMx1Info", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfGetMX1InfoGoodsItem> goods;
    @XmlElementRef(name = "edoStatusId", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetMx1Info", type = JAXBElement.class, required = false)
    protected JAXBElement<Short> edoStatusId;
    @XmlElementRef(name = "typeFoundationDocument", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetMx1Info", type = JAXBElement.class, required = false)
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfGetMX1InfoGoodsItem }{@code >}
     *     
     */
    public JAXBElement<ArrayOfGetMX1InfoGoodsItem> getGoods() {
        return goods;
    }
     ...
     *     
     */
    public void setGoods(JAXBElement<ArrayOfGetMX1InfoGoodsItem> value) {
        this.goods = value;
    }
