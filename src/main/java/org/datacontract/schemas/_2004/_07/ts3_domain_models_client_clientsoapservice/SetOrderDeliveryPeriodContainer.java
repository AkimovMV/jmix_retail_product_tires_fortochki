...
/**
 * <p>Java class for SetOrderDeliveryPeriodContainer complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SetOrderDeliveryPeriodContainer">
 *   <complexContent>
...
@XmlType(name = "SetOrderDeliveryPeriodContainer", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SetOrderDelivery", propOrder = {
    "addressId",
    "deliveryDate",
    "deliveryIntervalId",
    "orderNumber"
})
public class SetOrderDeliveryPeriodContainer {

    @XmlElementRef(name = "AddressId", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SetOrderDelivery", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> addressId;
    @XmlElement(name = "DeliveryDate")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar deliveryDate;
    @XmlElementRef(name = "DeliveryIntervalId", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SetOrderDelivery", type = JAXBElement.class, required = false)
