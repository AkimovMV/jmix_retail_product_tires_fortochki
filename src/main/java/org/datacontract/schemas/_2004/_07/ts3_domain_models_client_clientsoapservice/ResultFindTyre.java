...
/**
 * <p>Java class for ResultFindTyre complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ResultFindTyre">
 *   <complexContent>
 ...
 *         <element name="price_rest_list" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SearchTires}ArrayOfTyrePriceRest" minOccurs="0"/>
...
@XmlType(name = "ResultFindTyre", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SearchTires", propOrder = {
    "currencyRate",
    "error",
    "priceRestList",
    "saleInfoList",
...
public class ResultFindTyre {

    @XmlElementRef(name = "currencyRate", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SearchTires", type = JAXBElement.class, required = false)
    protected JAXBElement<CurrencyRate> currencyRate;
    @XmlElementRef(name = "error", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SearchTires", type = JAXBElement.class, required = false)
    protected JAXBElement<Error> error;
    @XmlElementRef(name = "price_rest_list", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SearchTires", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfTyrePriceRest> priceRestList;
    @XmlElementRef(name = "saleInfoList", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SearchTires", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfsaleInfo> saleInfoList;
    protected Integer totalPages;
    @XmlElementRef(name = "warehouseLogistics", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SearchTires", type = JAXBElement.class, required = false)
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfTyrePriceRest }{@code >}
     *     
     */
    public JAXBElement<ArrayOfTyrePriceRest> getPriceRestList() {
     ...
     *     
     */
    public void setPriceRestList(JAXBElement<ArrayOfTyrePriceRest> value) {
