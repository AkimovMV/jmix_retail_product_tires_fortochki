...
@XmlType(name = "MarkCodeContainer", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetSaleInfo", propOrder = {
    "markCodeImg",
    "markCodeString",
    "artikul"
})
public class MarkCodeContainer4 {

    @XmlElementRef(name = "MarkCodeImg", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetSaleInfo", type = JAXBElement.class, required = false)
    protected JAXBElement<String> markCodeImg;
    @XmlElementRef(name = "MarkCodeString", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetSaleInfo", type = JAXBElement.class, required = false)
