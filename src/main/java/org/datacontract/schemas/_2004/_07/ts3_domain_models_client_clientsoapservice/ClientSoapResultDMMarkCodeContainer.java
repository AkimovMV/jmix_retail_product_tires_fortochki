...
@XmlType(name = "ClientSoapResultDM.MarkCodeContainer", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetOrderInfo", propOrder = {
    "markCodeImg",
    "markCodeString",
    "artikul"
})
public class ClientSoapResultDMMarkCodeContainer {

    @XmlElementRef(name = "MarkCodeImg", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetOrderInfo", type = JAXBElement.class, required = false)
    protected JAXBElement<String> markCodeImg;
    @XmlElementRef(name = "MarkCodeString", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetOrderInfo", type = JAXBElement.class, required = false)
    protected JAXBElement<String> markCodeString;
    @XmlElementRef(name = "artikul", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetOrderInfo", type = JAXBElement.class, required = false)
