...
/**
 * <p>Java class for GetPressureSensorResult complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="GetPressureSensorResult">
 *   <complexContent>
 ...
 *         <element name="items" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPressureSensor}ArrayOfPressureSensorContainer" minOccurs="0"/>
...
@XmlType(name = "GetPressureSensorResult", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPressureSensor", propOrder = {
    "currencyRate",
    "error",
    "items",
    "totalPages",
...
public class GetPressureSensorResult {

    @XmlElementRef(name = "currencyRate", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPressureSensor", type = JAXBElement.class, required = false)
    protected JAXBElement<CurrencyRate> currencyRate;
    @XmlElementRef(name = "error", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPressureSensor", type = JAXBElement.class, required = false)
    protected JAXBElement<Error> error;
    @XmlElementRef(name = "items", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPressureSensor", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfPressureSensorContainer2> items;
    protected Integer totalPages;
    @XmlElementRef(name = "warehouseLogistics", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPressureSensor", type = JAXBElement.class, required = false)
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfPressureSensorContainer2 }{@code >}
     *     
     */
    public JAXBElement<ArrayOfPressureSensorContainer2> getItems() {
        return items;
    }
     ...
     *     
     */
    public void setItems(JAXBElement<ArrayOfPressureSensorContainer2> value) {
        this.items = value;
    }
