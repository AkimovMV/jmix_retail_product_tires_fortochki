...
@XmlType(name = "MarkCodeContainer", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SetMarkCodeList", propOrder = {
    "markCodeLabelUrl",
    "markCodeString",
    "markCodeUrl",
    "productCode"
})
public class MarkCodeContainer3 {

    @XmlElementRef(name = "MarkCodeLabelUrl", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SetMarkCodeList", type = JAXBElement.class, required = false)
    protected JAXBElement<String> markCodeLabelUrl;
    @XmlElementRef(name = "MarkCodeString", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SetMarkCodeList", type = JAXBElement.class, required = false)
    protected JAXBElement<String> markCodeString;
    @XmlElementRef(name = "MarkCodeUrl", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SetMarkCodeList", type = JAXBElement.class, required = false)
    protected JAXBElement<String> markCodeUrl;
    @XmlElementRef(name = "ProductCode", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SetMarkCodeList", type = JAXBElement.class, required = false)
