...
/**
 * <p>Java class for GetRtuCorrectionInfoResult.RtuCorrectionMarkCodeContainer complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="GetRtuCorrectionInfoResult.RtuCorrectionMarkCodeContainer">
 *   <complexContent>
...
@XmlType(name = "GetRtuCorrectionInfoResult.RtuCorrectionMarkCodeContainer", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetRtuCorrectionInfo", propOrder = {
    "imgUrl",
    "markCode",
    "productCode"
})
public class GetRtuCorrectionInfoResultRtuCorrectionMarkCodeContainer {

    @XmlElementRef(name = "imgUrl", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetRtuCorrectionInfo", type = JAXBElement.class, required = false)
    protected JAXBElement<String> imgUrl;
    @XmlElementRef(name = "markCode", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetRtuCorrectionInfo", type = JAXBElement.class, required = false)
