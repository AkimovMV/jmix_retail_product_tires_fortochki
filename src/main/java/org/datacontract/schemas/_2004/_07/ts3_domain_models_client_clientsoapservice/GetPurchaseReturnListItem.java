...
/**
 * <p>Java class for GetPurchaseReturnListItem complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="GetPurchaseReturnListItem">
 *   <complexContent>
...
@XmlType(name = "GetPurchaseReturnListItem", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPurchaseReturnList", propOrder = {
    "contractName",
    "contractNumber",
    "contractSum",
    "date",
...
public class GetPurchaseReturnListItem {

    @XmlElementRef(name = "contractName", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPurchaseReturnList", type = JAXBElement.class, required = false)
    protected JAXBElement<String> contractName;
    @XmlElementRef(name = "contractNumber", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPurchaseReturnList", type = JAXBElement.class, required = false)
    protected JAXBElement<String> contractNumber;
    protected BigDecimal contractSum;
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar date;
    @XmlElementRef(name = "edoStatusId", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPurchaseReturnList", type = JAXBElement.class, required = false)
    protected JAXBElement<Short> edoStatusId;
    @XmlElementRef(name = "guid", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPurchaseReturnList", type = JAXBElement.class, required = false)
    protected JAXBElement<String> guid;
    @XmlElementRef(name = "guidBaseDocument", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPurchaseReturnList", type = JAXBElement.class, required = false)
    protected JAXBElement<String> guidBaseDocument;
    @XmlElementRef(name = "number", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPurchaseReturnList", type = JAXBElement.class, required = false)
    protected JAXBElement<String> number;
    @XmlElementRef(name = "numberBaseDocument", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPurchaseReturnList", type = JAXBElement.class, required = false)
    protected JAXBElement<String> numberBaseDocument;
    @XmlElementRef(name = "sfDate", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPurchaseReturnList", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> sfDate;
    @XmlElementRef(name = "sfNumber", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPurchaseReturnList", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sfNumber;
    protected Integer statusId;
    @XmlElementRef(name = "updateDate", namespace = "http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPurchaseReturnList", type = JAXBElement.class, required = false)
