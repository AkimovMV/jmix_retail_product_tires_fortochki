...
@XmlRootElement(name = "GetStoOrderInfo")
public class GetStoOrderInfo {
    ...
    @XmlElementRef(name = "dateTime", namespace = "Wcf.ClientService.Client.WebAPI.TS3", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dateTime;
    @XmlElementRef(name = "orderID", namespace = "Wcf.ClientService.Client.WebAPI.TS3", type = JAXBElement.class, required = false)
