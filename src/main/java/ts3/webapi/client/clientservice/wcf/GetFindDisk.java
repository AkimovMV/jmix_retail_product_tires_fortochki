 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SearchDiscs}FindDiskFilter" minOccurs="0"/>
...
@XmlRootElement(name = "GetFindDisk")
public class GetFindDisk {
    ...
    protected JAXBElement<FindDiskFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link FindDiskFilter }{@code >}
     *     
     */
    public JAXBElement<FindDiskFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<FindDiskFilter> value) {
        this.filter = value;
    }
