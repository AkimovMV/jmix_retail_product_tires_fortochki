 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetRtuCorrectionList}GetRtuCorrectionListFilter" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "GetRtuCorrectionList")
public class GetRtuCorrectionList {
    ...
    protected JAXBElement<GetRtuCorrectionListFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetRtuCorrectionListFilter }{@code >}
     *     
     */
    public JAXBElement<GetRtuCorrectionListFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<GetRtuCorrectionListFilter> value) {
        this.filter = value;
    }
