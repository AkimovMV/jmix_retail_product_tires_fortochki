 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetMx3List}GetMx3ListFilter" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "GetMX3List")
public class GetMX3List {
    ...
    protected JAXBElement<GetMx3ListFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetMx3ListFilter }{@code >}
     *     
     */
    public JAXBElement<GetMx3ListFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<GetMx3ListFilter> value) {
        this.filter = value;
    }
