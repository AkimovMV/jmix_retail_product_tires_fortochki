 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetConsumable}GetConsumableFilter" minOccurs="0"/>
...
@XmlRootElement(name = "GetConsumable")
public class GetConsumable {
    ...
    protected JAXBElement<GetConsumableFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetConsumableFilter }{@code >}
     *     
     */
    public JAXBElement<GetConsumableFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<GetConsumableFilter> value) {
        this.filter = value;
    }
