 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPrice}getPriceFilter" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class GetPrice {
    ...
    protected JAXBElement<GetPriceFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetPriceFilter }{@code >}
     *     
     */
    public JAXBElement<GetPriceFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<GetPriceFilter> value) {
        this.filter = value;
    }
