 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetFindCamera}GetFindCameraFilter" minOccurs="0"/>
...
@XmlRootElement(name = "GetFindCamera")
public class GetFindCamera {
    ...
    protected JAXBElement<GetFindCameraFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetFindCameraFilter }{@code >}
     *     
     */
    public JAXBElement<GetFindCameraFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<GetFindCameraFilter> value) {
        this.filter = value;
    }
