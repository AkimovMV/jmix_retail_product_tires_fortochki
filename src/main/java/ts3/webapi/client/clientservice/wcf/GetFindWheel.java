 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetFindWheel}GetFindWheelFilter" minOccurs="0"/>
...
@XmlRootElement(name = "GetFindWheel")
public class GetFindWheel {
    ...
    protected JAXBElement<GetFindWheelFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetFindWheelFilter }{@code >}
     *     
     */
    public JAXBElement<GetFindWheelFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<GetFindWheelFilter> value) {
        this.filter = value;
    }
