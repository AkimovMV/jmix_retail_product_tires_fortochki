...
@XmlRootElement(name = "SetDeliveryInfo")
public class SetDeliveryInfo {
    ...
    @XmlElementRef(name = "deliveryInfo", namespace = "Wcf.ClientService.Client.WebAPI.TS3", type = JAXBElement.class, required = false)
