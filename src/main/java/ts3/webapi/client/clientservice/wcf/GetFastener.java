 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetFastener}getFastenerFilter" minOccurs="0"/>
...
@XmlRootElement(name = "GetFastener")
public class GetFastener {
    ...
    protected JAXBElement<GetFastenerFilter> filter;
    @XmlElementRef(name = "page", namespace = "Wcf.ClientService.Client.WebAPI.TS3", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> page;
    @XmlElementRef(name = "pageSize", namespace = "Wcf.ClientService.Client.WebAPI.TS3", type = JAXBElement.class, required = false)
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetFastenerFilter }{@code >}
     *     
     */
    public JAXBElement<GetFastenerFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<GetFastenerFilter> value) {
        this.filter = value;
    }
