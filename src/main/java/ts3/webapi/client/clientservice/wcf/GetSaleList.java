 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetSaleList}SaleFilter" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "GetSaleList")
public class GetSaleList {
    ...
    protected JAXBElement<SaleFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link SaleFilter }{@code >}
     *     
     */
    public JAXBElement<SaleFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<SaleFilter> value) {
        this.filter = value;
    }
