...
@XmlRootElement(name = "SetWorkCompleted")
public class SetWorkCompleted {
    ...
    @XmlElementRef(name = "code", namespace = "Wcf.ClientService.Client.WebAPI.TS3", type = JAXBElement.class, required = false)
