...
@XmlRootElement(name = "CheckVerificationCodeByQRCode")
public class CheckVerificationCodeByQRCode {
    ...
    @XmlElementRef(name = "qrCode", namespace = "Wcf.ClientService.Client.WebAPI.TS3", type = JAXBElement.class, required = false)
