 ...
 *         <element name="priceTypeID" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
 *         <element name="list" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SetSupplierPrice}ArrayOfSupplierPriceItem" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "SetSupplierPrice")
public class SetSupplierPrice {
    ...
    protected Integer priceTypeID;
    @XmlElementRef(name = "list", namespace = "Wcf.ClientService.Client.WebAPI.TS3", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfSupplierPriceItem> list;
     ...
     *     
     */
    public JAXBElement<ArrayOfSupplierPriceItem> getList() {
        return list;
    }
     ...
     *     
     */
    public void setList(JAXBElement<ArrayOfSupplierPriceItem> value) {
        this.list = value;
    }
