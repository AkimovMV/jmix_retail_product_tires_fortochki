...
@XmlRootElement(name = "SetStoRemoveFromOH")
public class SetStoRemoveFromOH {
    ...
    @XmlElementRef(name = "verificationCode", namespace = "Wcf.ClientService.Client.WebAPI.TS3", type = JAXBElement.class, required = false)
