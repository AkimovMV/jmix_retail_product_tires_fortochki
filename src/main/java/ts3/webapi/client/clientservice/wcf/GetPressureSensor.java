 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPressureSensor}getPressureSensorFilter" minOccurs="0"/>
...
@XmlRootElement(name = "GetPressureSensor")
public class GetPressureSensor {
    ...
    protected JAXBElement<GetPressureSensorFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetPressureSensorFilter }{@code >}
     *     
     */
    public JAXBElement<GetPressureSensorFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<GetPressureSensorFilter> value) {
        this.filter = value;
    }
