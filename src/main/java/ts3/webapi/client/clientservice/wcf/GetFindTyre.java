 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SearchTires}FindTyreFilter" minOccurs="0"/>
...
@XmlRootElement(name = "GetFindTyre")
public class GetFindTyre {
    ...
    protected JAXBElement<FindTyreFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link FindTyreFilter }{@code >}
     *     
     */
    public JAXBElement<FindTyreFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<FindTyreFilter> value) {
        this.filter = value;
    }
