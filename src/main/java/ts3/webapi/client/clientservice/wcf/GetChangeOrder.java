 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetChangedOrders}FindChangeOrderFilter" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "GetChangeOrder")
public class GetChangeOrder {
    ...
    protected JAXBElement<FindChangeOrderFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link FindChangeOrderFilter }{@code >}
     *     
     */
    public JAXBElement<FindChangeOrderFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<FindChangeOrderFilter> value) {
        this.filter = value;
    }
