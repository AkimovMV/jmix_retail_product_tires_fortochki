...
@XmlRootElement(name = "CheckInventoryMarkCode")
public class CheckInventoryMarkCode {
    ...
    @XmlElementRef(name = "markCodeString", namespace = "Wcf.ClientService.Client.WebAPI.TS3", type = JAXBElement.class, required = false)
