 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetAddressList}getAddressListFilter" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class GetAddressList {
    ...
    protected JAXBElement<GetAddressListFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetAddressListFilter }{@code >}
     *     
     */
    public JAXBElement<GetAddressListFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<GetAddressListFilter> value) {
        this.filter = value;
    }
