...
@XmlRootElement(name = "CreateInventory")
public class CreateInventory {
    ...
    @XmlElementRef(name = "scannerType", namespace = "Wcf.ClientService.Client.WebAPI.TS3", type = JAXBElement.class, required = false)
    protected JAXBElement<Short> scannerType;
     ...
     *     
     */
    public JAXBElement<Short> getScannerType() {
        return scannerType;
    }
     ...
     *     
     */
    public void setScannerType(JAXBElement<Short> value) {
