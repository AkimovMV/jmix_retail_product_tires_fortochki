 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetStoOrderList}GetStoOrderListFilter" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "GetStoOrderList")
public class GetStoOrderList {
    ...
    protected JAXBElement<GetStoOrderListFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetStoOrderListFilter }{@code >}
     *     
     */
    public JAXBElement<GetStoOrderListFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<GetStoOrderListFilter> value) {
        this.filter = value;
    }
