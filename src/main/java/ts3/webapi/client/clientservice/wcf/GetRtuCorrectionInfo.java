...
@XmlRootElement(name = "GetRtuCorrectionInfo")
public class GetRtuCorrectionInfo {
    ...
    @XmlElementRef(name = "number", namespace = "Wcf.ClientService.Client.WebAPI.TS3", type = JAXBElement.class, required = false)
