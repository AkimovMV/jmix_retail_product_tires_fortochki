 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetPurchaseReturnList}GetPurchaseReturnListFilter" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "GetPurchaseReturnList")
public class GetPurchaseReturnList {
    ...
    protected JAXBElement<GetPurchaseReturnListFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetPurchaseReturnListFilter }{@code >}
     *     
     */
    public JAXBElement<GetPurchaseReturnListFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<GetPurchaseReturnListFilter> value) {
        this.filter = value;
    }
