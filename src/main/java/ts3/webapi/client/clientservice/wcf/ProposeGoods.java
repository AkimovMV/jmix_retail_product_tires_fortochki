 ...
 *         <element name="proposal" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.ProposeGoods}proposeGoodsContainer" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "ProposeGoods")
public class ProposeGoods {
    ...
    @XmlElementRef(name = "proposal", namespace = "Wcf.ClientService.Client.WebAPI.TS3", type = JAXBElement.class, required = false)
    protected JAXBElement<ProposeGoodsContainer> proposal;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ProposeGoodsContainer }{@code >}
     *     
     */
    public JAXBElement<ProposeGoodsContainer> getProposal() {
        return proposal;
    }
     ...
     *     
     */
    public void setProposal(JAXBElement<ProposeGoodsContainer> value) {
        this.proposal = value;
    }
