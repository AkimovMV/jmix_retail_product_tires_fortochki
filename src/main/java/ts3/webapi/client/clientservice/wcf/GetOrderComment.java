 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetOrderComment}FindOrderCommentFilter" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "GetOrderComment")
public class GetOrderComment {
    ...
    protected JAXBElement<FindOrderCommentFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link FindOrderCommentFilter }{@code >}
     *     
     */
    public JAXBElement<FindOrderCommentFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<FindOrderCommentFilter> value) {
        this.filter = value;
    }
