 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SearchProductsBySpecs}GetGoodsByCarFilter" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "GetGoodsByCar")
public class GetGoodsByCar {
    ...
    protected JAXBElement<GetGoodsByCarFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetGoodsByCarFilter }{@code >}
     *     
     */
    public JAXBElement<GetGoodsByCarFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<GetGoodsByCarFilter> value) {
        this.filter = value;
    }
