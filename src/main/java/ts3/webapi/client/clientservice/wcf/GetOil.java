 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.GetOil}GetOilFilter" minOccurs="0"/>
...
public class GetOil {
    ...
    protected JAXBElement<GetOilFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetOilFilter }{@code >}
     *     
     */
    public JAXBElement<GetOilFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<GetOilFilter> value) {
        this.filter = value;
    }
