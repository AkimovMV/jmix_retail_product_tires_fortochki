 ...
 *         <element name="filter" type="{http://schemas.datacontract.org/2004/07/TS3.Domain.Models.Client.ClientSoapService.SearchProductsAndPricesInfo}GoodsPriceRestFilter" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "GetGoodsPriceRestByCode")
public class GetGoodsPriceRestByCode {
    ...
    protected JAXBElement<GoodsPriceRestFilter> filter;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GoodsPriceRestFilter }{@code >}
     *     
     */
    public JAXBElement<GoodsPriceRestFilter> getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(JAXBElement<GoodsPriceRestFilter> value) {
        this.filter = value;
    }
